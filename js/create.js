			...
			$.ajax({
				...
				success: function(data) {
					...
					switch(data.message){
						...
						break;
						case "failBindApp404":
							alert("合併失敗 資料無法傳遞 請重新操作");
						break;
						case "failBindApp412":
							alert("合併失敗 資料傳遞錯誤 請重新操作");
						break;
						case "failBindApp500":
							alert("合併失敗 網路不穩定 請重新操作");
						break;
						case "failBindApp502":
							alert("合併失敗 網路不穩定 請重新操作");
						break;
						case "failCreateAppUser404":
							alert("創建失敗 資料無法傳遞 請重新操作");
						break;
						case "failCreateAppUser412":
							alert("創建失敗 資料傳遞錯誤 請重新操作");
						break;
						case "failCreateAppUser500":
							alert("創建失敗 網路不穩定 請重新操作");
						break;
						case "failCreateAppUser502":
							alert("創建失敗 網路不穩定 請重新操作");
						break;
						default:
							alert("系統錯誤，請重新輸入");
