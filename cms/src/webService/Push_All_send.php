<?php
	...
	function pushNotificationByDeviceOS($token, $os, $message, $link, $email, $password){
	...
	if(isset($_POST['pushMessage'])&&isset($_POST['pushLink'])&&isset($_POST['appToken'])&&isset($_POST['pushOS'])&&isset($_POST['email'])&&isset($_POST['password']))
	{
		...
		pushNotificationByDeviceOS($appToken, $appOS, $pushMessage, $pushLink, $email, $password);
