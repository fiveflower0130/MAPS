	...
	if(isset($_POST['App_Email'])&&isset($_POST['App_Phone']))
	{
		...
		if($tel&&$mail)
		{
			...
			if($checkAppUser == "true")
			{
				...
				$mail->IsHTML(true);
				$mail->Username = "appmaker.service@gmail.com";//google帳戶
				$mail->Password = "Foxconn88";// google密碼
				$mail->From = "appmaker.service@gmail.com";
				$mail->FromName = "MAPs客服";
				$mail->SetFrom = "appmaker.service@gmail.com";
				$mail->Subject = "MAPs-密碼提醒";//信件內容主題
