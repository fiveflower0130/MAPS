<?php
	...
	function pushNotificationByUuid($token, $list, $message, $link, $email, $password){
	...
	if(isset($_POST['pushMessage'])&&isset($_POST['pushLink'])&&isset($_POST['appToken'])&&isset($_POST['pushChecked'])&&isset($_POST['email'])&&isset($_POST['password'])){
		...
		if(!empty($addPush))
		{
			pushNotificationByUuid($appToken, $addPush , $pushMessage, $pushLink, $email, $password);
		}
		else{
			$data = array(
					'message' => 'uuidEmpty'
