...
            		<textarea name="textarea-enhanced" id="textarea-enhanced" data-enhanced="true" class="ui-input-text ui-shadow-inset ui-body-inherit ui-corner-all" placeholder="請輸入您的意見.." required></textarea>
...
            		<button type="submit" id="sendAbout" class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-btn-icon-left ui-icon-mail">確認送出</button>
					<!--<input type="submit" id="sendAbout"  value = "確認送出">-->
        		</div>
    		</form>
		</div>
    </div>
